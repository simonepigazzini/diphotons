...
$mydir/bkg_bias.py --n-toys $ntoys \
    --store-new-only \
    --components "" --models dijet --use-data \
    --read-ws $inputfile  -o $outname \
    --fit-toys \
    --fit-name cic2 \
    --saveas png \
    --test-range 1000,1200 --test-range 1200,1800 --test-range 1800,2500 --test-range 2500,3500 --test-range 3500,4500 --test-range 500,550 --test-range 550,600 --test-range 600,650 --test-range 650,700 --test-range 700,750 --test-range 750,800 --test-range 800,900 --test-range 900,1000 --test-range 4500,5000 \
    --first-toy $toy \
    $@
