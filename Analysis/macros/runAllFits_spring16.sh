...
dir2016=full_analysis_spring17v1_sync_v1
lumi2016=35.9
...
common_opts="--rescale-signal-to 1e-3 --minos-bands --generate-ws-bkgnbias-new --prepare-data --do-parametric-signal-nuisances --plot-blind 500,4000"
...
# parallel --ungroup -j 1 "./combine_maker.sh $dir2016 --lumi $lumi2016 --fit-name cic2016 $common_opts --parametric-signal-new $CMSSW_BASE/src/DiPhotonSignalModel/ProduceSignalModel/80X/SignalParametericShapes80X_ws_kMpl{}.root --parametric-signal-acceptance  acceptance_76_spin0.json --load lumi.json --only-coups {}   --label spin0_${label} --do-parametric-signal-nuisances --model-strip-coeff-names 016" ::: $coups &
